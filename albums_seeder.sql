...
VALUES ('anyone', 'name', 2021, 1, 'better');

INSERT INTO albums (artist, name, release_date, sales, genre)
VALUES ('hello', 'there', 2021, 5, 'greeting');

INSERT INTO albums (artist, name, release_date, sales, genre)
VALUES ('oy', 'oy', 2021, 1, 'yoyo'),
        ('random', 'idk', 1776, 1776, 'best'),
        ('afdsg', 'asdfasdf', 1992, 5346354, 'bdrdgdrsg'),
        ('ansdg', 'nadfsge', 2021, 1, 'bdsfgtter'),
        ('anyonegfd', 'namdgfse', 2021, 1, 'bettergdf');
